...
<details>
  ...
  <ul>
    <li>新增相册分组管理与筛选能力，支持在主界面快捷操作分组。</li>
    <li>新增移动/复制冲突处理策略，并进一步优化大图详情、搜索和文件夹浏览体验。</li>
  </ul>
</details>

1. 新增相册分组管理与分组筛选，支持在主界面快捷操作分组。
2. 新增系统回收站支持（Android 11及以上）。
3. 新增移动/复制冲突处理策略，支持重命名、覆盖、跳过。
4. 优化大图查看页显示选项、详情面板布局与沉浸式浏览体验。
5. 优化搜索补全、预搜索结果、文件夹浏览和文件传输助手的使用体验。
6. 优化视频播放控制、时间轴显示、长按范围选择和“修复拍摄时间”等交互细节。
7. 新增繁体中文语言支持，并支持切换 Android 11+ 删除 API。
8. 修复部分设备照片或视频丢失显示、相册列表不刷新等问题。
9. 修复浏览大图手势冲突、删除后界面未及时更新、第三方应用打开文件崩溃等问题。

#### 0.1.53(2026-01-17)
<details>
  <summary>重点更新内容变动(点我查看)</summary>
  <ul>
    <li>部分用户反馈浏览大图的时候，使用壁纸会影响视觉，可以在设置中开启大图浏览使用纯色背景</li>
    <li>点击相册后,右上角菜单新增固定分组</li>
  </ul>
</details>


1. 新增双击直接播放视频，点击视频时长文字播放视频。
2. 新增相册固定分组功能。
3. 新增无缝浏览支持双击放大图片后拖动照片查看。
4. 新增大图浏览时使用纯色背景的选项。
5. 在应用“关于”中新增分享应用给朋友的功能。
6. 优化手机在内存不足时回到应用丢失浏览进度或出现白屏的问题。
7. 优化设置：将“幻灯片动画”改为“翻页动画”，此选项将应用于大图浏览。
8. 优化回收站的排序方式。
9. 优化隐私空间的卸载提示。
10. 优化幻灯片播放的动画延迟时间。
11. 优化幻灯片中的随机播放模式。
12. 优化移动照片时列表布局的相册路径显示。
13. 优化打赏功能，新增PayPal渠道。
14. 优化应用部分场景下的英文翻译。
15. 优化在移动/复制时创建新文件夹后直接进入该文件夹。
16. 优化点击相册后照片列表的加载速度。
17. 优化开启文件传输助手时申请忽略电池优化权限。
18. 优化工具栏上的照片数量统计显示。
19. 移除设置项中多余的图标显示。
20. 修复日间模式下移动照片时列表布局相册路径无法显示的问题。
21. 修复部分设备在排除文件夹时无法选择外置SD卡的问题。
22. 修复浏览记录列表不显示视频长度的问题。
23. 修复部分设备视频播放滑动控制音量失败的问题。
24. 修复一些加载GIF动画失败的问题。
25. 修复搜索照片可能出现的卡顿。
26. 修复隐私空间无法显示视频分辨率的问题。


#### 0.1.50(2025-11-23)

1. 新增设置底部属性显示地理位置功能
2. 新增照片浏览翻页和播放实况图的振动效果
3. 新增实况图片自动播放设置选项
4. 新增幻灯片随机播放功能
5. 优化移动、复制操作，支持复制和移动到指定文件夹，记住最近操作相册置顶
6. 优化应用内存占用，提升整体性能
7. 优化10W+数量级照片的加载速度
8. 解决浏览全图时在部分设备上的卡顿问题
9. 改善夜间模式下列表布局的相册名称和文件名字体颜色显示
10. 调整排除相册列表的缩略图宽高显示
11. 修正设置中最大亮度选择时间范围后的显示错误
12. 修复部分设备使用隐私空间时的崩溃问题
13. 修正隐私空间在部分设备上下滑手势跳过PIN码校验的问题
14. 解决相册长按手势多选不一致的问题
15. 修复实况照片在部分三星、小米设备播放失败的问题
16. 解决部分设备照片时间线显示为1970年的问题
17. 修复部分设备手势返回导致意外退出应用的问题
